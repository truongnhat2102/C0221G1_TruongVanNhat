...
@WebServlet(name = "Servlet", urlPatterns = {"/customers",""})
public class Servlet extends HttpServlet {
    ...
    private void listCustomers(HttpServletRequest request, HttpServletResponse response) throws NullPointerException{
