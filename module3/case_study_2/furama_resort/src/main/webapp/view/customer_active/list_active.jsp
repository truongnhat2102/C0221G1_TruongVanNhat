                ...
                <table class="table table-striped table-hover">
                    ...
                    <c:forEach var="customer" items="${customers}">
                        ...
                        <tr>
                            ...
                            <td>${customer.getTypeCustomer().getNameTypeCustomer()}</td>
                            <c:forEach var="extraService" items="${extraServices}">
                                <p>${extraService.nameExtraService}</p>
                            </c:forEach>
                            <td>
                                <button type="button" class="btn btn-primary" class="settings" title="Settings"
                                        data-toggle="tooltip"><a href="/list_active?action=editService&id=${customer.id}"><i
