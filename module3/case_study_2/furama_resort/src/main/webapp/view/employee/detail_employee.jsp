...
<div class="signup-form">
    <form method="post">
        ...
        <div class="form-group">
            <input disabled class="form-control" name="position" placeholder="Position" value="${employee.position.getNamePosition()}" required="required">
        </div>
        <div class="form-group">
            <input disabled class="form-control" name="educationDegree" placeholder="Education Degree" value="${employee.educationDegree.getNameEducation()}" required="required">
        </div>
        <div class="form-group">
            <input disabled class="form-control" name="dividion" placeholder="Dividion" value="${employee.division.getNameDivision()}" required="required">
        </div>
        <div class="form-group">
