...
<div class="signup-form">
    <form method="post">
        ...
        <div class="form-group">
            <input disabled class="form-control" name="standardRoom" placeholder="standardRoom">
        </div>
        <div class="form-group">
            <input disabled class="form-control" name="description" placeholder="Description">
        </div>
        <div class="form-group">
            <input disabled class="form-control" name="poolArea" placeholder="House not have pool">
        </div>
        <div class="form-group">
            <input disabled class="form-control" name="floor" placeholder="Many floors">
        </div>
        <div class="form-group">
