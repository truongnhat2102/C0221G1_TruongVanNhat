            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-xs-7">
                            <a href="/product?action=add" class="btn btn-primary"><i
                ...
                <table class="table table-striped table-hover">
                    ...
                    <c:forEach var="product" items="${productList}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td>${product.color}</td>
                            <td>${product.productCategory.nameProductCategory}</td>
                            <td>
                                <button type="button" class="btn btn-primary" class="settings" title="Settings"
                                        data-toggle="tooltip"><a href="/product?action=edit&id=${product.idProduct}"><i
                                        style="color: white" class="material-icons">&#xE8B8;</i></a></button>
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#exampleModalLong" onclick="sendDataToModal('${product.idProduct}')">
